    ...
    if (open) {
      ...
      if (accountReceivable) {
        setFormData({
          ...
          origem: accountReceivable.origem || "",
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle>
            {accountReceivable ? "Editar Conta a Receber" : "Nova Conta a Receber"}
          </DialogTitle>
          <DialogDescription>
            {accountReceivable
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <DialogFooter>
            ...
            <Button type="submit" disabled={loading}>
              {loading ? "Salvando..." : accountReceivable ? "Atualizar" : "Criar"}
            </Button>
          </DialogFooter>
        </form>
      </DialogContent>
